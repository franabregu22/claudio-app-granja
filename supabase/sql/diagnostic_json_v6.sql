-- ============================================================================
-- DIAGNOSTIC v6: Test INSERT COMPLETO (source + financial_movement + link + ledger)
-- Con rollback seguro
-- Reproduce LITERALMENTE la lógica real de import_financial_pipeline_rpc_v2
-- ============================================================================

CREATE OR REPLACE FUNCTION diagnostic_json_v6(p_input JSONB)
RETURNS JSONB AS $$
DECLARE
  v_records JSONB[];
  v_record JSONB;
      ...
      BEGIN
        ...
        IF v_source_record_id IS NOT NULL THEN
          ...
          IF v_existing_fm_id IS NULL THEN
            -- ================================================================
            -- SCENARIO C: Primer source → crear financial_movement + link + ledger
            -- Reproduce LITERALMENTE líneas 157-215 de import_financial_pipeline_rpc_v2
            -- ================================================================
            ...
            -- ================================================================
            -- Crear ledger_entry (líneas 194-213 de v2)
            -- ================================================================
